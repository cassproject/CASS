...
var counter = 0;
if (debug) console.log("@type:assertion AND \\*@reader:\"" + subject + "\" AND competency:\"" + competencyId.replaceAll(/:/, "\\:").replaceAll(/\./, "\\\.").replaceAll(/\//, "\\/") + '"');
repo.search("@type:assertion AND \\*@reader:\"" + subject + "\" AND competency:\"" + competencyId.replaceAll(/:/, "\\:").replaceAll(/\./, "\\\.").replaceAll(/\//, "\\/") + '"',
