...
4. Select the target branch for the release (e.g., `1.6`, `1.7`).
5. Choose the type of version bump (`major`, `minor`, `patch`, or `prerelease`).
6. Click **Run workflow**.

### What happens next?
The GitHub Action will check out the code, run `npm upgrade --save`, and bump the `package.json` version. It will handle creating a new branch and automatically open a **Pull Request** against the major/minor target branch (e.g., `1.7`).
