...
var signatureSheet = function() {
    ...
    for (var i = 0; i < sigSheet.length; i++) {
        ...
        if (getTypeFromObject(sigSheet[i]) != "https://schema.cassproject.org/kbac/0.4/TimeLimitedSignature" && getTypeFromObject(sigSheet[i]) != "http://schema.cassproject.org/kbac/0.3/TimeLimitedSignature" && getTypeFromObject(sigSheet[i]) != "http://schema.cassproject.org/kbac/0.2/TimeLimitedSignature")
