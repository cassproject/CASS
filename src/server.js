...
var skyrepoGet = async function(parseParams) {
...
app.listen(port, async () => {    
    elasticSearchInfo = await httpGet(elasticEndpoint + "/", true);
    console.log(`CaSS listening at http://localhost:${port}`);
    EcFramework.search(repo,"*",function(results){console.log("TEST!");console.log(results);},console.error);
});
